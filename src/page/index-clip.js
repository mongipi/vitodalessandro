...
export default function IndexClip(){
                ...
                <div className="row mt-5 align-items-center">
                    <div className="col-lg-7 col-md-7 mt-4 pt-2 mt-sm-0 pt-sm-0 order-2 order-md-1">
                        <div className="title-heading text-center text-md-start">
                            <h1 className="heading mb-3">I Am 
                                <TypeAnimation
                                    sequence={[
                                        'Cristino Murphy',
                                        1000,
                    ...
                    <div className="col-lg-5 col-md-5 order-1 order-md-2">
                        <div className="hero-img">
                            <img src={heroImg} className="avatar avatar-lg rounded-circle mx-auto d-block shadow-lg img-thumbnail" alt=""/>
                        </div>
                    </div>
                </div>
            </div> 
