...
import bg3 from '../assets/images/home/05.jpg'
...
export default function IndexSlider(){
    ...
    return(
        ...
        <Carousel controls={false} indicators={false} slide={true}>
            <Carousel.Item>
                <section className="bg-home" id="home" style={{backgroundImage:`url(${bg1})`}}>
                    <div className="bg-overlay bg-over-image"></div>
                    <div className="container">
                        <div className="row mt-5 mt-sm-0 justify-content-center">
                            <div className="col-lg-12 text-center">
                                <div className="title-heading">
                                    <img src={heroImg} className="img-fluid rounded-circle" alt="" style={{width:'200px', height:'200px'}}/>
                                    <h1 className="heading text-primary mt-3">Cristino Murphy</h1>
                                    <h6 className="sub-title text-light title-dark">I'm a Passionate 
                                        <TypeAnimation
                                        sequence={[
                                            'Web Designer',
                                            3000,
            ...
            <Carousel.Item>
                <section className="bg-home" id="home" style={{backgroundImage:`url(${bg2})`}}>
                    <div className="bg-overlay bg-over-image"></div>
                    <div className="container">
                        <div className="row mt-5 mt-sm-0 justify-content-center">
                            <div className="col-lg-12 text-center">
            ...
            <Carousel.Item>
                <section className="bg-home" id="home" style={{backgroundImage:`url(${bg3})`}}>
                    <div className="bg-overlay bg-over-image"></div>
                    <div className="container">
                        <div className="row mt-5 mt-sm-0 justify-content-center">
                            <div className="col-lg-12 text-center">
        ...
        {/* <Carousel autoPlay={true} infiniteLoop={true} interval={3000} showArrows={false} showStatus={false} showIndicators={false} rtlClass="carousel-rtl">
            <section className="bg-home" id="home" style={{backgroundImage:`url(${bg1})`}}>
                <div className="bg-overlay bg-over-image"></div>
                <div className="container">
                    <div className="row mt-5 mt-sm-0 justify-content-center">
