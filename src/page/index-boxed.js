...
import bg1 from '../assets/images/boxed.png'
import bg2 from '../assets/images/home/04.jpg'
...
export default function IndexBoxed(){
    let [ activeIndex, setActiveIndex ] = useState(1);
    return(
        <>
        <div id="sThemes-layout" style={{backgroundImage:`url(${bg1})`, backgroundAttachment:'fixed', backgroundRepeat:'repeat'}}>
            <div className="sThemesbox">
                <Navbar navClass="navbar-nav mx-auto" socialClass="list-unstyled mb-0 mt-2 mt-sm-0 social-icon light-social-icon"/>

                <section className="bg-half d-table w-100" style={{backgroundImage:`url(${bg2})`}} id="home">
                        ...
                        <div className="row justify-content-center mt-5">
                            <div className="col-lg-12 text-center">
                                <div className="title-heading">
                                    ...
                                    <h5 className="sub-title font-weight-normal text-light">I'm a Passionate
                                        <TypeAnimation
                                            sequence={[
                                                'Web Designer',
                                                1000,
                                    ...
                                    <div className="mt-4">
                                        <Link to="#" className="btn btn-primary">Download CV <FiDownload className="fea icon-sm"/></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <Link1 to="about" data-scroll-nav="1" className="mouse-icon mouse-icon-white rounded-pill mouse-down">
                    ...
                    <div className="container">
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-7 col-md-7 mt-4 pt-2 mt-sm-0 pt-sm-0">
                                <div className="section-title mb-0 ms-lg-5 ms-md-3">
