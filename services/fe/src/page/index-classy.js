...
import bg1 from "../assets/images/home/02.png"
...
import { FiStar, FiRefreshCw, } from '../assets/icons/vander'
...
export default function IndexClassy(){
    ...
    return(
        ...
        <section className="full-home personal-hero d-flex align-items-center background-effect overflow-hidden" id="home">
              
                
            <div className="container-fluid">
                <Parallax
                    bgImage={bg1}
                    bgImageStyle={{width:'auto', height:'100%'}}
                    bgStyle={{with:"auto", height:"100%" }}
                    blur={{ min: 0, max: 0}}
                    strength={500}
                    style={{position:'absolute', width:'100%',backgroundPosition:'bottom'}}
                    className="bg-overlay bg-overlay-primary"
                    />
                            ...
                            <div className="title-heading">
                                <div className="row">
                                    <div className="col-lg-4 col-md-6">
                                        <h4 className="display-3 title fw-bold mb-0">Cristino <br/> 
                                            <TypeAnimation
                                                sequence={[
                                                    'Murphy!',
                                                    1000,
                                    ...
                                    <div className="col-lg-5 offset-lg-3 col-md-6 mt-4 mt-sm-0">
                                        ...
                                        <div className="rounded personal-hero-para">
                                            ...
                                            <div className="mt-4">
                                                <a href="#project" className="btn btn-primary">Hire me</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <section className="section pb-3 overflow-hidden" id="about">
            ...
            <div className="container-fluid mt-100 mt-60 ">
                ...
                />
                <div className="rounded py-md-5 py-4">
                    <div className="container">
        ...
        <section className="cta-full border-top">
            <div className="container-fluid">
                <div className="row position-relative">
                    <div className="col-lg-4 padding-less img">
                        <Parallax
                        blur={{ min: 0, max: 0}}
                        bgImage={ctaBg}
                        bgImageAlt="the dog"
        ...
        <section className="cta-full">
            <div className="container-fluid">
                <div className="row position-relative">
                    ...
                    <div className="col-lg-4 offset-lg-8 padding-less img order-1">
                        <Parallax
                            blur={{ min: 0, max: 0}}
                            bgImage={testibg}
                            bgImageAlt="the dog"
