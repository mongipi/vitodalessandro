...
export default function IndexVideo(){
    ...
    return(
        ...
        <section className="full-home d-flex align-items-center" id="home">
            <div className="bg-video-wrapper">
                <iframe src="https://player.vimeo.com/video/676644046?background=1&autoplay=1&loop=1&byline=0&title=0" title="myfram"></iframe>
            </div>
                ...
                <div className="row mt-5 mt-sm-0 justify-content-center">
                    <div className="col-lg-12 text-center">
                        <div className="title-heading">
                            ...
                            <p className="para-desc mx-auto text-white title-dark">Obviously I'm a Web Designer. Web Developer with over 3 years of experience. Experienced with all stages of the development cycle for dynamic web projects.</p>
                            <div className="mt-4">
                                <Link to="#" className="btn btn-primary rounded me-2 mb-2">Hire me</Link>
                                <Link to="#" className="btn btn-outline-primary rounded mb-2">Download CV <FiDownload className="fea icon-sm"></FiDownload></Link>
                            </div>
                        </div>
                    </div>
                </div>
