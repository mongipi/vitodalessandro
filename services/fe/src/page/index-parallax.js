...
export default function IndexParallax(){
    ...
    return(
        ...
        <section className="bg-home bg-light d-table w-100 jarallax" data-jarallax data-speed="0.5"  id="home">
            <Parallax
                blur={{ min: 0, max: 0}}
                bgImage={bg1}
                ...
                bgStyle={{with:"auto", height:"120%", bottom:'0' }}
                style={{position:"absolute", width:"100%" , height:"100%", bottom:'0', zIndex:'1'}} 
            />
            <div className="container">
                <div className="row mt-5 align-items-center">
                    <div className="col-lg-12">
                        <div className="title-heading mt-5">
                            <h6 className="sub-title">Hey ! This is Cristino</h6>
                            <h1 className="heading text-primary mb-3">UX / UI Designer</h1>
        ...
        <section className="cta-full">
            <div className="container-fluid">
                <div className="row position-relative">
                    ...
                    <div className="col-lg-4 offset-lg-8 padding-less img order-1" style={{backgroundImage:`url(${testibg})`}} >
                        <Parallax
                            blur={{ min: 0, max: 0}}
                            bgImage={testibg}
                            bgImageAlt="the dog"
