...
strapi:
	...
	docker compose -p strapi -f services/strapi-cloud-template-blog-aecd06639e/docker-compose.yml build --build-arg NODE_ENV=production -f services/strapi-cloud-template-blog-aecd06639e/Dockerfile.prod
